...
*   *Mám* (I have) → ***Ne**mám* (I don't have)
*   *Dělám* (I do) → ***Ne**dělám* (I don't do)
*   *Spím* (I sleep) → ***Ne**spím* (I am not sleeping)

### Exception
The verb **být** (to be) in the 3rd person singular is irregular.
*   *Je* (He is) → ***Není*** (He is not) - *Not "neje"!*
...
*   *S nikým nemluvím.* (I am not talking with anyone.)
