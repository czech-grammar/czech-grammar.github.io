...
| Order | Type | Examples |
| :--- | :--- | :--- |
| **0** | **Conjunctions** | *že, a, když...* (Start of clause) |
| **1** | **Auxiliary "být"** | *jsem, jsi, jsme, jste* (Past) / *bych, bys...* (Cond) |
| **2** | **Reflexive** | *se, si* |
| **3** | **Dative** | *mi, ti, mu, jí, nám, vám, jim* |
| **4** | **Accusative** | *mě, tě, ho, ji, to, nás, vás, je* |

### Examples

*   **Reflexive only**:
    *   *Já **se** myji.* (I wash myself.)
*   **Auxiliary + Reflexive**:
    *   *Já **jsem se** myl.* (I washed myself.)
...
### Common Mistakes
*   *Já myl se.* (WRONG - *se* must be 2nd) -> *Já **se** myl.*
