...
*   **Od** (from): *Od **Petra**.*
*   **Do** (into/to): *Do **Prahy**.*
*   **Z/Ze** (out of/from): *Z **domu**.*
*   **Bez** (without): *Bez **cukru**.*
*   **U** (at/by): *U **babičky**.*
*   **Během** (during): *Během **dne**.*
*   **Kromě** (except): *Kromě **tebe**.*
*   **Vedle** (next to): *Vedle **školy**.*
*   **Okolo/Kolem** (around): *Kolem **stolu**.*
