...
:::tip Core Concept: The Locative = PLACE
...
![Locative Singular Cheat Sheet](/img/locative-singular-cheatsheet.svg)
...
![Locative Singular Flowchart](/img/locative-singular-flowchart.svg)
...
**v záchodě** = inside the toilet bowl (literal)
**na záchodě** = in the bathroom/restroom (correct)
...
| Type | Ending | Example |
| :--- | :--- | :--- |
| Hard | **-ých** | *v krásn**ých** městech* |
| Soft | **-ích** | *o ciz**ích** lidech* |
| Possessive | **-ích** | *v matkč**iných** dopisech* |
...
❌ *v strojech* → ✅ *ve strojích* (soft stem)
❌ *o mužech* → ✅ *o mužích* (soft stem)
❌ *v lesích* → ✅ *v lesech* or *v lesích* (both acceptable)

### 2. Forgetting Stem Changes

❌ *o člověcích* → ✅ *o lidech*
❌ *v rocích* → ✅ *v letech* (for years of time)
❌ *o dítěch* → ✅ *o dětech*

### 3. Using Singular Instead of Plural

❌ *Na stole jsou knihy.* (Where are books? On the table.) — ✅ correct but singular *stole*
✅ *Na **stolech** jsou knihy.* (Books are on the tables.) — plural

### 4. Wrong Preposition

❌ *do městech* → ✅ *v městech* or *do měst* (Genitive for motion)
Remember: Locative = static location; Genitive/Accusative = motion

### 5. Mixing Declension Patterns

❌ *o soudcách* → ✅ *o soudcích* (follows soft pattern)
❌ *v mořech* → ✅ *v mořích* (soft neuter)
...
## Practice: Singular to Plural Transformation

Transform these Locative Singular forms to Plural:

| Singular | Plural |
| :--- | :--- |
| *v domě* (in the house) | *v dom**ech*** |
| *o ženě* (about the woman) | *o žen**ách*** |
| *na poli* (in the field) | *na pol**ích*** |
| *v autě* (in the car) | *v aut**ech*** |
| *o problému* (about the problem) | *o problém**ech*** |
| *při práci* (during work) | *při prác**ích*** |
| *v noci* (at night) | *v noc**ích*** |
| *o člověku* (about the person) | *o **lidech*** |

---

## Practice: Fill in the Endings (-ech, -ách, -ích)

:::tip Soft Consonants
Remember: **ž, š, č, ř, ď, ť, ň, c, j** are soft consonants → use **-ích**
:::

Complete these sentences with the correct locative plural ending:

**1.** Turisté chodili po starých ulic**___** a náměst**___**.

<details>
<summary>Answer</summary>

po ulic**ích**, náměst**ích**

*ulice* (soft -c-) → **-ích**, *náměstí* (soft) → **-ích**
</details>

**2.** Mluvili jsme o svých problém**___** a starost**___**.

<details>
<summary>Answer</summary>

o problém**ech**, starost**ech**

*problém* (hard) → **-ech**, *starost* (kost type) → **-ech**
</details>

**3.** Děti si hrály v park**___** a na hřišt**___**.

<details>
<summary>Answer</summary>

v parc**ích**, na hřišt**ích**

*park* (soft -k- before -ích) → **-ích**, *hřiště* (soft) → **-ích**
</details>

**4.** V těch restaurac**___** vaří výborné jídlo.
...
*restaurace* (soft -c-) → **-ích**
</details>

**5.** Informace o lét**___** najdete na našich stránk**___**.

<details>
<summary>Answer</summary>

o let**ech**, na stránk**ách**

*leto/rok* → *letech* (irregular), *stránky* (žena type) → **-ách**
</details>

**6.** Slyšel jsem o těch knih**___** a film**___**.
...
*kniha* (žena type) → **-ách**, *film* (hard) → **-ech**
</details>

**7.** Pracuje v nemocnic**___** a škol**___** po celé zemi.

<details>
<summary>Answer</summary>

v nemocnic**ích**, škol**ách**

*nemocnice* (soft -c-) → **-ích**, *škola* (žena type) → **-ách**
</details>

**8.** Na zahrad**___** rostou květiny, na pol**___** roste obilí.

<details>
<summary>Answer</summary>

na zahrad**ách**, na pol**ích**

*zahrada* (žena type) → **-ách**, *pole* (moře type, soft) → **-ích**
</details>
