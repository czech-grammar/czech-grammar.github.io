---
title: Plural Declensions
sidebar_position: 12
---

# Plural Declensions (Skloňování v množném čísle)
...
| **Dat** | hrad**ům** | stroj**ům** | -ům |
| **Acc** | hrad**y** | stroj**e** | = Nom |
| **Voc** | hrad**y**! | stroj**e**! | = Nom |
...
| **Dat** | žen**ám** | růž**ím** | kost**em** |
| **Acc** | žen**y** | růž**e** | kost**i** |
| **Voc** | žen**y**! | růž**e**! | kost**i**! |
...
| **Acc** | měst**a** | moř**e** |
| **Voc** | měst**a**! | moř**e**! |
| **Loc** | měst**ech** | moř**ích** |
| **Instr** | měst**y** | moř**i** |

## Summary of Similarities

1.  **Dative Plural**: Always ends in **-m** (usually *-ům, -ám, -ím*).
2.  **Locative Plural**: Always ends in **-ch** (usually *-ech, -ách, -ích*).
3.  **Instrumental Plural**: Always ends in **-mi** (Feminine) or **-y/i** (Masculine/Neuter).
